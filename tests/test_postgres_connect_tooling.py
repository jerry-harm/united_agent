...
class PostgresConnectToolingTest(unittest.TestCase):
    ...
    def test_connect_skill_documents_bundled_script_flow(self) -> None:
        ...
        self.assertIn('uv run --with "psycopg[binary]" python skills/agent-kb-postgres-connect/scripts/<entrypoint>', content)
        ...
        self.assertIn('python skills/agent-kb-postgres-connect/scripts/change_password.py', content)
        self.assertIn('python skills/agent-kb-postgres-connect/scripts/list_content.py --list-boards', content)
        self.assertIn('python skills/agent-kb-postgres-connect/scripts/upload_text_file.py', content)
        self.assertIn('python skills/agent-kb-postgres-connect/scripts/read_uploaded_file.py', content)
